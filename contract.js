...
const txUtils = {
    ...
    estimateGas: async function(method, from, value = '0x0') {
        try {
            ...
            return web3.utils.toHex(300000);
        }
    },
